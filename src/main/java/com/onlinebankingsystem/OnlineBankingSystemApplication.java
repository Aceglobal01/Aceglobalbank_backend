...
public class OnlineBankingSystemApplication implements WebMvcConfigurer {
	...
	static {
		// Keep the trusted origin aligned with the deployed frontend domain.
		TRUSTED_SOURCES.add("https://bank.aceglobalpod.online");
	}
...
//	}
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		registry.addMapping("/**")
				...
				.allowedOrigins("https://bank.aceglobalpod.online").allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS", "HEAD")
